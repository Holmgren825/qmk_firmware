...
[_LAYER0] = LAYOUT(
     ...
     KC_PSCR, MT(MOD_LALT, KC_A), MT(MOD_LCTL ,KC_S), MT(MOD_LGUI, KC_D), MT(MOD_LSFT, KC_F), KC_G, KC_H, MT(MOD_RSFT, KC_J), MT(MOD_RGUI, KC_K), MT(MOD_RCTL, KC_L), MT(MOD_RALT, KC_SCLN), KC_VOLD,
     KC_NO, KC_Z, KC_X, KC_C, KC_V, KC_B, KC_NO, KC_NO, KC_NO, KC_NO, KC_N, KC_M, KC_COMM, KC_DOT, KC_SLSH, KC_MNXT,
     TT(4), LSFT_T(KC_DEL), KC_DEL, LT(3, KC_ESC), KC_BSPC, KC_TAB, LT(1, KC_SPC), KC_ENT, KC_TAB, KC_MPLY),

[_LAYER1] = LAYOUT(
        KC_NO, KC_EXLM, KC_AT, KC_HASH, KC_DLR, KC_PERC, KC_CIRC, KC_AMPR, KC_ASTR, KC_PLUS, KC_BSLS, KC_NO,
        KC_NO, KC_DQUO, KC_CIRC, KC_LBRC, KC_LCBR, KC_LPRN, KC_RPRN, KC_RCBR, KC_RBRC, KC_MINS, KC_UNDS, KC_PIPE,
...
[_LAYER4] = LAYOUT(
        ...
        KC_PSCR, MT(MOD_LALT, KC_A), MT(MOD_LCTL, KC_S), MT(MOD_LGUI, KC_D), MT(MOD_LSFT, KC_F), KC_G, KC_H, MT(MOD_RSFT, KC_J), MT(MOD_RGUI, KC_K), MT(MOD_RCTL, KC_L), MT(MOD_RALT, KC_SCLN), KC_QUOT,
     KC_NO, KC_Z, KC_X, KC_C, KC_V, KC_B, KC_NO, KC_NO, KC_NO, KC_NO, KC_N, KC_M, KC_COMM, KC_DOT, KC_SLSH, KC_MNXT,
     KC_NO, KC_TRNS , TO(0), KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS)
