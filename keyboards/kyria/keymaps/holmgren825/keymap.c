...
[_LAYER0] = LAYOUT(
     ...
     TT(4), LSFT_T(KC_DEL) , TT(1), LGUI_T(KC_ESC), LCTL_T(KC_TAB), MT(MOD_LCTL | MOD_LGUI, KC_BSPC), LSFT_T(KC_SPC), LALT_T(KC_ENT), KC_TAB, KC_MPLY),

[_LAYER1] = LAYOUT(
        KC_NO, KC_EXLM, KC_AT, KC_HASH, KC_DLR, KC_PERC, KC_CIRC, KC_AMPR, KC_ASTR, KC_PLUS, KC_BSLS, KC_NO,
        KC_NO, KC_NO, KC_CIRC, KC_LBRC, KC_LCBR, KC_LPRN, KC_RPRN, KC_RCBR, KC_RBRC, KC_MINS, KC_UNDS, KC_PIPE,
